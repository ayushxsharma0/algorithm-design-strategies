...
void KruskalsMCST(int A[3][9]){
    ...
    int set[V+1] = {-1, -1, -1, -1, -1, -1, -1, -1};  // Array for finding cycle (set)
...
int main() {
    //we use a 3-rowed matrix to store edge and its weight
    //edges[0] and edges[1] give first and second vertices respectively and edges[2] its weight
